...
generate-oapi: install-oapi-codegen
	oapi-codegen -generate types -package api ./internal/api/openapi.yaml > ./internal/api/types.go
	oapi-codegen -generate server -package api ./internal/api/openapi.yaml > ./internal/api/server.go