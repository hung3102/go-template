...
//go:generate ../../../../../bin/mockgen -source $GOFILE -destination mocks/payment_gen.go

// PaymentRepository - Repository of Payment
type PaymentRepository interface {
	// Single
	Get(ctx context.Context, id string, opts ...GetOption) (*model.Payment, error)
	GetWithDoc(ctx context.Context, doc *firestore.DocumentRef, opts ...GetOption) (*model.Payment, error)
	Insert(ctx context.Context, subject *model.Payment) (_ string, err error)
	Update(ctx context.Context, subject *model.Payment) (err error)
	StrictUpdate(ctx context.Context, id string, param *PaymentUpdateParam, opts ...firestore.Precondition) error
	Delete(ctx context.Context, subject *model.Payment, opts ...DeleteOption) (err error)
	DeleteByID(ctx context.Context, id string, opts ...DeleteOption) (err error)
	// Multiple
	GetMulti(ctx context.Context, ids []string, opts ...GetOption) ([]*model.Payment, error)
	InsertMulti(ctx context.Context, subjects []*model.Payment) (_ []string, er error)
	UpdateMulti(ctx context.Context, subjects []*model.Payment) (er error)
	DeleteMulti(ctx context.Context, subjects []*model.Payment, opts ...DeleteOption) (er error)
	DeleteMultiByIDs(ctx context.Context, ids []string, opts ...DeleteOption) (er error)
	// Single(Transaction)
	GetWithTx(tx *firestore.Transaction, id string, opts ...GetOption) (*model.Payment, error)
	GetWithDocWithTx(tx *firestore.Transaction, doc *firestore.DocumentRef, opts ...GetOption) (*model.Payment, error)
	InsertWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.Payment) (_ string, err error)
	UpdateWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.Payment) (err error)
	StrictUpdateWithTx(tx *firestore.Transaction, id string, param *PaymentUpdateParam, opts ...firestore.Precondition) error
	DeleteWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.Payment, opts ...DeleteOption) (err error)
	DeleteByIDWithTx(ctx context.Context, tx *firestore.Transaction, id string, opts ...DeleteOption) (err error)
	// Multiple(Transaction)
	GetMultiWithTx(tx *firestore.Transaction, ids []string, opts ...GetOption) ([]*model.Payment, error)
	InsertMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.Payment) (_ []string, er error)
	UpdateMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.Payment) (er error)
	DeleteMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.Payment, opts ...DeleteOption) (er error)
	DeleteMultiByIDsWithTx(ctx context.Context, tx *firestore.Transaction, ids []string, opts ...DeleteOption) (er error)
	// Search
	Search(ctx context.Context, param *PaymentSearchParam, q *firestore.Query) ([]*model.Payment, error)
	SearchWithTx(tx *firestore.Transaction, param *PaymentSearchParam, q *firestore.Query) ([]*model.Payment, error)
	SearchByParam(ctx context.Context, param *PaymentSearchParam) ([]*model.Payment, *PagingResult, error)
	SearchByParamWithTx(tx *firestore.Transaction, param *PaymentSearchParam) ([]*model.Payment, *PagingResult, error)
	// misc
...
// PaymentRepositoryMiddleware - middleware of PaymentRepository
type PaymentRepositoryMiddleware interface {
	BeforeInsert(ctx context.Context, subject *model.Payment) (bool, error)
	BeforeUpdate(ctx context.Context, old, subject *model.Payment) (bool, error)
	BeforeDelete(ctx context.Context, subject *model.Payment, opts ...DeleteOption) (bool, error)
...
type paymentRepository struct {
	...
	middleware       []PaymentRepositoryMiddleware
	uniqueRepository *uniqueRepository
}

// NewPaymentRepository - constructor
func NewPaymentRepository(firestoreClient *firestore.Client, middleware ...PaymentRepositoryMiddleware) PaymentRepository {
	return &paymentRepository{
		collectionName:   "payment",
		firestoreClient:  firestoreClient,
		middleware:       middleware,
		uniqueRepository: newUniqueRepository(firestoreClient, "payment"),
	}
}

func (repo *paymentRepository) setMeta(subject *model.Payment, isInsert bool) {
	now := time.Now()
...
func (repo *paymentRepository) setMetaWithStrictUpdate(param *PaymentUpdateParam) {
	param.UpdatedAt = firestore.ServerTimestamp
	param.Version = firestore.Increment(1)
}

func (repo *paymentRepository) beforeInsert(ctx context.Context, subject *model.Payment) error {
...
func (repo *paymentRepository) beforeUpdate(ctx context.Context, old, subject *model.Payment) error {
...
func (repo *paymentRepository) beforeDelete(ctx context.Context, subject *model.Payment, opts ...DeleteOption) error {
	repo.setMeta(subject, false)
	repo.uniqueRepository.setMiddleware(ctx)
...
func (repo *paymentRepository) GetCollection() *firestore.CollectionRef {
	return repo.firestoreClient.Collection(repo.collectionName)
}

// GetCollectionName - CollectionName getter
func (repo *paymentRepository) GetCollectionName() string {
	return repo.collectionName
}

// GetDocRef - *firestore.DocumentRef getter
func (repo *paymentRepository) GetDocRef(id string) *firestore.DocumentRef {
	return repo.GetCollection().Doc(id)
}

// RunInTransaction - (*firestore.Client).RunTransaction getter
func (repo *paymentRepository) RunInTransaction() func(ctx context.Context, f func(context.Context, *firestore.Transaction) error, opts ...firestore.TransactionOption) (err error) {
	return repo.firestoreClient.RunTransaction
}

// PaymentSearchParam - params for search
type PaymentSearchParam struct {
	ID           *QueryChainer
	EventID      *QueryChainer
	BillingID    *QueryChainer
	PaymentNumID *QueryChainer
	Cost         *QueryChainer
...
// PaymentUpdateParam - params for strict updates
type PaymentUpdateParam struct {
	EventID      interface{}
	BillingID    interface{}
	PaymentNumID interface{}
	Cost         interface{}
	CreatedAt    interface{}
	CreatedBy    interface{}
	UpdatedAt    interface{}
...
func (repo *paymentRepository) Search(ctx context.Context, param *PaymentSearchParam, q *firestore.Query) ([]*model.Payment, error) {
	return repo.search(ctx, param, q)
}

// SearchByParam - search documents by search param
func (repo *paymentRepository) SearchByParam(ctx context.Context, param *PaymentSearchParam) ([]*model.Payment, *PagingResult, error) {
	return repo.searchByParam(ctx, param)
}

// Get - get `Payment` by `Payment.ID`
func (repo *paymentRepository) Get(ctx context.Context, id string, opts ...GetOption) (*model.Payment, error) {
	doc := repo.GetDocRef(id)
	return repo.get(ctx, doc, opts...)
}

// GetWithDoc - get `Payment` by *firestore.DocumentRef
func (repo *paymentRepository) GetWithDoc(ctx context.Context, doc *firestore.DocumentRef, opts ...GetOption) (*model.Payment, error) {
	return repo.get(ctx, doc, opts...)
}

// Insert - insert of `Payment`
func (repo *paymentRepository) Insert(ctx context.Context, subject *model.Payment) (_ string, err error) {
...
// Update - update of `Payment`
func (repo *paymentRepository) Update(ctx context.Context, subject *model.Payment) (err error) {
	doc := repo.GetDocRef(subject.ID)
...
// StrictUpdate - strict update of `Payment`
func (repo *paymentRepository) StrictUpdate(ctx context.Context, id string, param *PaymentUpdateParam, opts ...firestore.Precondition) error {
	return repo.strictUpdate(ctx, id, param, opts...)
}

// Delete - delete of `Payment`
func (repo *paymentRepository) Delete(ctx context.Context, subject *model.Payment, opts ...DeleteOption) (err error) {
...
// DeleteByID - delete `Payment` by `Payment.ID`
func (repo *paymentRepository) DeleteByID(ctx context.Context, id string, opts ...DeleteOption) (err error) {
...
// GetMulti - get `Payment` in bulk by array of `Payment.ID`
func (repo *paymentRepository) GetMulti(ctx context.Context, ids []string, opts ...GetOption) ([]*model.Payment, error) {
	return repo.getMulti(ctx, ids, opts...)
}

// InsertMulti - bulk insert of `Payment`
func (repo *paymentRepository) InsertMulti(ctx context.Context, subjects []*model.Payment) (_ []string, er error) {
...
// UpdateMulti - bulk update of `Payment`
func (repo *paymentRepository) UpdateMulti(ctx context.Context, subjects []*model.Payment) (er error) {
...
// DeleteMulti - bulk delete of `Payment`
func (repo *paymentRepository) DeleteMulti(ctx context.Context, subjects []*model.Payment, opts ...DeleteOption) (er error) {
...
// DeleteMultiByIDs - delete `Payment` in bulk by array of `Payment.ID`
func (repo *paymentRepository) DeleteMultiByIDs(ctx context.Context, ids []string, opts ...DeleteOption) (er error) {
	subjects := make([]*model.Payment, len(ids))
...
func (repo *paymentRepository) SearchWithTx(tx *firestore.Transaction, param *PaymentSearchParam, q *firestore.Query) ([]*model.Payment, error) {
	return repo.search(tx, param, q)
}

// SearchByParamWithTx - search documents by search param in transaction
func (repo *paymentRepository) SearchByParamWithTx(tx *firestore.Transaction, param *PaymentSearchParam) ([]*model.Payment, *PagingResult, error) {
	return repo.searchByParam(tx, param)
}

// GetWithTx - get `Payment` by `Payment.ID` in transaction
func (repo *paymentRepository) GetWithTx(tx *firestore.Transaction, id string, opts ...GetOption) (*model.Payment, error) {
	doc := repo.GetDocRef(id)
	return repo.get(tx, doc, opts...)
}

// GetWithDocWithTx - get `Payment` by *firestore.DocumentRef in transaction
func (repo *paymentRepository) GetWithDocWithTx(tx *firestore.Transaction, doc *firestore.DocumentRef, opts ...GetOption) (*model.Payment, error) {
	return repo.get(tx, doc, opts...)
}

// InsertWithTx - insert of `Payment` in transaction
func (repo *paymentRepository) InsertWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.Payment) (_ string, err error) {
...
// UpdateWithTx - update of `Payment` in transaction
func (repo *paymentRepository) UpdateWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.Payment) (err error) {
...
// StrictUpdateWithTx - strict update of `Payment` in transaction
func (repo *paymentRepository) StrictUpdateWithTx(tx *firestore.Transaction, id string, param *PaymentUpdateParam, opts ...firestore.Precondition) error {
	return repo.strictUpdate(tx, id, param, opts...)
}

// DeleteWithTx - delete of `Payment` in transaction
func (repo *paymentRepository) DeleteWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.Payment, opts ...DeleteOption) (err error) {
...
// DeleteByIDWithTx - delete `Payment` by `Payment.ID` in transaction
func (repo *paymentRepository) DeleteByIDWithTx(ctx context.Context, tx *firestore.Transaction, id string, opts ...DeleteOption) (err error) {
...
// GetMultiWithTx - get `Payment` in bulk by array of `Payment.ID` in transaction
func (repo *paymentRepository) GetMultiWithTx(tx *firestore.Transaction, ids []string, opts ...GetOption) ([]*model.Payment, error) {
	return repo.getMulti(tx, ids, opts...)
}

// InsertMultiWithTx - bulk insert of `Payment` in transaction
func (repo *paymentRepository) InsertMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.Payment) (_ []string, er error) {
...
// UpdateMultiWithTx - bulk update of `Payment` in transaction
func (repo *paymentRepository) UpdateMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.Payment) (er error) {
...
// DeleteMultiWithTx - bulk delete of `Payment` in transaction
func (repo *paymentRepository) DeleteMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.Payment, opts ...DeleteOption) (er error) {
...
// DeleteMultiByIDWithTx - delete `Payment` in bulk by array of `Payment.ID` in transaction
func (repo *paymentRepository) DeleteMultiByIDsWithTx(ctx context.Context, tx *firestore.Transaction, ids []string, opts ...DeleteOption) (er error) {
...
func (repo *paymentRepository) get(v interface{}, doc *firestore.DocumentRef, opts ...GetOption) (*model.Payment, error) {
	var (
...
func (repo *paymentRepository) getMulti(v interface{}, ids []string, opts ...GetOption) ([]*model.Payment, error) {
	var (
	...
	subjects := make([]*model.Payment, 0, len(ids))
	mErr := NewMultiErrors()
...
func (repo *paymentRepository) insert(v interface{}, subject *model.Payment) (string, error) {
	var (
...
func (repo *paymentRepository) update(v interface{}, subject *model.Payment) error {
	var (
		dr  = repo.GetDocRef(subject.ID)
		err error
	)
...
func (repo *paymentRepository) strictUpdate(v interface{}, id string, param *PaymentUpdateParam, opts ...firestore.Precondition) error {
	var (
	...
	updates := updater(model.Payment{}, param)
...
func (repo *paymentRepository) deleteByID(v interface{}, id string) error {
	dr := repo.GetDocRef(id)
	var err error
...
func (repo *paymentRepository) runQuery(v interface{}, query firestore.Query) ([]*model.Payment, error) {
...
func (repo *paymentRepository) searchByParam(v interface{}, param *PaymentSearchParam) ([]*model.Payment, *PagingResult, error) {
	...
	if param.PaymentNumID != nil {
		for _, chain := range param.PaymentNumID.QueryGroup {
			query = query.Where("payment_num_id", chain.Operator, chain.Value)
		}
		if direction := param.PaymentNumID.OrderByDirection; direction > 0 {
			query = query.OrderBy("payment_num_id", direction)
			query = param.PaymentNumID.BuildCursorQuery(query)
		}
	}
	if param.Cost != nil {
...
func (repo *paymentRepository) search(v interface{}, param *PaymentSearchParam, q *firestore.Query) ([]*model.Payment, error) {
