...
func NewPaymentNumRepository(firestoreClient *firestore.Client, middleware ...PaymentNumRepositoryMiddleware) PaymentNumRepository {
	return &paymentNumRepository{
		collectionName:   "PaymentNum",
		firestoreClient:  firestoreClient,
		middleware:       middleware,
		uniqueRepository: newUniqueRepository(firestoreClient, "PaymentNum"),
	}
}
...
func (repo *paymentNumRepository) searchByParam(v interface{}, param *PaymentNumSearchParam) ([]*model.PaymentNum, *PagingResult, error) {
	...
	if param.PaymentNum != nil {
		for _, chain := range param.PaymentNum.QueryGroup {
			query = query.Where("PaymentNum", chain.Operator, chain.Value)
		}
		if direction := param.PaymentNum.OrderByDirection; direction > 0 {
			query = query.OrderBy("PaymentNum", direction)
