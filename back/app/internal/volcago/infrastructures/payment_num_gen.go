...
//go:generate ../../../../../bin/mockgen -source $GOFILE -destination mocks/payment_num_gen.go

// PaymentNumRepository - Repository of PaymentNum
type PaymentNumRepository interface {
	// Single
	Get(ctx context.Context, id string, opts ...GetOption) (*model.PaymentNum, error)
	GetWithDoc(ctx context.Context, doc *firestore.DocumentRef, opts ...GetOption) (*model.PaymentNum, error)
	Insert(ctx context.Context, subject *model.PaymentNum) (_ string, err error)
	Update(ctx context.Context, subject *model.PaymentNum) (err error)
	StrictUpdate(ctx context.Context, id string, param *PaymentNumUpdateParam, opts ...firestore.Precondition) error
	Delete(ctx context.Context, subject *model.PaymentNum, opts ...DeleteOption) (err error)
	DeleteByID(ctx context.Context, id string, opts ...DeleteOption) (err error)
	// Multiple
	GetMulti(ctx context.Context, ids []string, opts ...GetOption) ([]*model.PaymentNum, error)
	InsertMulti(ctx context.Context, subjects []*model.PaymentNum) (_ []string, er error)
	UpdateMulti(ctx context.Context, subjects []*model.PaymentNum) (er error)
	DeleteMulti(ctx context.Context, subjects []*model.PaymentNum, opts ...DeleteOption) (er error)
	DeleteMultiByIDs(ctx context.Context, ids []string, opts ...DeleteOption) (er error)
	// Single(Transaction)
	GetWithTx(tx *firestore.Transaction, id string, opts ...GetOption) (*model.PaymentNum, error)
	GetWithDocWithTx(tx *firestore.Transaction, doc *firestore.DocumentRef, opts ...GetOption) (*model.PaymentNum, error)
	InsertWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.PaymentNum) (_ string, err error)
	UpdateWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.PaymentNum) (err error)
	StrictUpdateWithTx(tx *firestore.Transaction, id string, param *PaymentNumUpdateParam, opts ...firestore.Precondition) error
	DeleteWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.PaymentNum, opts ...DeleteOption) (err error)
	DeleteByIDWithTx(ctx context.Context, tx *firestore.Transaction, id string, opts ...DeleteOption) (err error)
	// Multiple(Transaction)
	GetMultiWithTx(tx *firestore.Transaction, ids []string, opts ...GetOption) ([]*model.PaymentNum, error)
	InsertMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.PaymentNum) (_ []string, er error)
	UpdateMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.PaymentNum) (er error)
	DeleteMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.PaymentNum, opts ...DeleteOption) (er error)
	DeleteMultiByIDsWithTx(ctx context.Context, tx *firestore.Transaction, ids []string, opts ...DeleteOption) (er error)
	// Search
	Search(ctx context.Context, param *PaymentNumSearchParam, q *firestore.Query) ([]*model.PaymentNum, error)
	SearchWithTx(tx *firestore.Transaction, param *PaymentNumSearchParam, q *firestore.Query) ([]*model.PaymentNum, error)
	SearchByParam(ctx context.Context, param *PaymentNumSearchParam) ([]*model.PaymentNum, *PagingResult, error)
	SearchByParamWithTx(tx *firestore.Transaction, param *PaymentNumSearchParam) ([]*model.PaymentNum, *PagingResult, error)
	// misc
...
// PaymentNumRepositoryMiddleware - middleware of PaymentNumRepository
type PaymentNumRepositoryMiddleware interface {
	BeforeInsert(ctx context.Context, subject *model.PaymentNum) (bool, error)
	BeforeUpdate(ctx context.Context, old, subject *model.PaymentNum) (bool, error)
	BeforeDelete(ctx context.Context, subject *model.PaymentNum, opts ...DeleteOption) (bool, error)
	BeforeDeleteByID(ctx context.Context, ids []string, opts ...DeleteOption) (bool, error)
}

type paymentNumRepository struct {
	collectionName   string
	firestoreClient  *firestore.Client
	middleware       []PaymentNumRepositoryMiddleware
	uniqueRepository *uniqueRepository
}

// NewPaymentNumRepository - constructor
func NewPaymentNumRepository(firestoreClient *firestore.Client, middleware ...PaymentNumRepositoryMiddleware) PaymentNumRepository {
	return &paymentNumRepository{
		collectionName:   "payment_num",
		firestoreClient:  firestoreClient,
		middleware:       middleware,
		uniqueRepository: newUniqueRepository(firestoreClient, "payment_num"),
	}
}

func (repo *paymentNumRepository) setMeta(subject *model.PaymentNum, isInsert bool) {
	now := time.Now()
...
func (repo *paymentNumRepository) setMetaWithStrictUpdate(param *PaymentNumUpdateParam) {
	param.UpdatedAt = firestore.ServerTimestamp
	param.Version = firestore.Increment(1)
}

func (repo *paymentNumRepository) beforeInsert(ctx context.Context, subject *model.PaymentNum) error {
...
func (repo *paymentNumRepository) beforeUpdate(ctx context.Context, old, subject *model.PaymentNum) error {
...
func (repo *paymentNumRepository) beforeDelete(ctx context.Context, subject *model.PaymentNum, opts ...DeleteOption) error {
	repo.setMeta(subject, false)
	repo.uniqueRepository.setMiddleware(ctx)
...
func (repo *paymentNumRepository) GetCollection() *firestore.CollectionRef {
	return repo.firestoreClient.Collection(repo.collectionName)
}

// GetCollectionName - CollectionName getter
func (repo *paymentNumRepository) GetCollectionName() string {
	return repo.collectionName
}

// GetDocRef - *firestore.DocumentRef getter
func (repo *paymentNumRepository) GetDocRef(id string) *firestore.DocumentRef {
	return repo.GetCollection().Doc(id)
}

// RunInTransaction - (*firestore.Client).RunTransaction getter
func (repo *paymentNumRepository) RunInTransaction() func(ctx context.Context, f func(context.Context, *firestore.Transaction) error, opts ...firestore.TransactionOption) (err error) {
	return repo.firestoreClient.RunTransaction
}

// PaymentNumSearchParam - params for search
type PaymentNumSearchParam struct {
	ID            *QueryChainer
	EventID       *QueryChainer
	BillingID     *QueryChainer
	BillingUnitID *QueryChainer
	PaymentNum    *QueryChainer
	Cost          *QueryChainer
...
// PaymentNumUpdateParam - params for strict updates
type PaymentNumUpdateParam struct {
	EventID       interface{}
	BillingID     interface{}
	BillingUnitID interface{}
	PaymentNum    interface{}
	Cost          interface{}
	CreatedAt     interface{}
	CreatedBy     interface{}
	UpdatedAt     interface{}
...
func (repo *paymentNumRepository) Search(ctx context.Context, param *PaymentNumSearchParam, q *firestore.Query) ([]*model.PaymentNum, error) {
	return repo.search(ctx, param, q)
}

// SearchByParam - search documents by search param
func (repo *paymentNumRepository) SearchByParam(ctx context.Context, param *PaymentNumSearchParam) ([]*model.PaymentNum, *PagingResult, error) {
	return repo.searchByParam(ctx, param)
}

// Get - get `PaymentNum` by `PaymentNum.ID`
func (repo *paymentNumRepository) Get(ctx context.Context, id string, opts ...GetOption) (*model.PaymentNum, error) {
	doc := repo.GetDocRef(id)
	return repo.get(ctx, doc, opts...)
}

// GetWithDoc - get `PaymentNum` by *firestore.DocumentRef
func (repo *paymentNumRepository) GetWithDoc(ctx context.Context, doc *firestore.DocumentRef, opts ...GetOption) (*model.PaymentNum, error) {
	return repo.get(ctx, doc, opts...)
}

// Insert - insert of `PaymentNum`
func (repo *paymentNumRepository) Insert(ctx context.Context, subject *model.PaymentNum) (_ string, err error) {
...
// Update - update of `PaymentNum`
func (repo *paymentNumRepository) Update(ctx context.Context, subject *model.PaymentNum) (err error) {
	doc := repo.GetDocRef(subject.ID)
...
// StrictUpdate - strict update of `PaymentNum`
func (repo *paymentNumRepository) StrictUpdate(ctx context.Context, id string, param *PaymentNumUpdateParam, opts ...firestore.Precondition) error {
	return repo.strictUpdate(ctx, id, param, opts...)
}

// Delete - delete of `PaymentNum`
func (repo *paymentNumRepository) Delete(ctx context.Context, subject *model.PaymentNum, opts ...DeleteOption) (err error) {
...
// DeleteByID - delete `PaymentNum` by `PaymentNum.ID`
func (repo *paymentNumRepository) DeleteByID(ctx context.Context, id string, opts ...DeleteOption) (err error) {
...
// GetMulti - get `PaymentNum` in bulk by array of `PaymentNum.ID`
func (repo *paymentNumRepository) GetMulti(ctx context.Context, ids []string, opts ...GetOption) ([]*model.PaymentNum, error) {
	return repo.getMulti(ctx, ids, opts...)
}

// InsertMulti - bulk insert of `PaymentNum`
func (repo *paymentNumRepository) InsertMulti(ctx context.Context, subjects []*model.PaymentNum) (_ []string, er error) {
...
// UpdateMulti - bulk update of `PaymentNum`
func (repo *paymentNumRepository) UpdateMulti(ctx context.Context, subjects []*model.PaymentNum) (er error) {
...
// DeleteMulti - bulk delete of `PaymentNum`
func (repo *paymentNumRepository) DeleteMulti(ctx context.Context, subjects []*model.PaymentNum, opts ...DeleteOption) (er error) {
...
// DeleteMultiByIDs - delete `PaymentNum` in bulk by array of `PaymentNum.ID`
func (repo *paymentNumRepository) DeleteMultiByIDs(ctx context.Context, ids []string, opts ...DeleteOption) (er error) {
	subjects := make([]*model.PaymentNum, len(ids))
...
func (repo *paymentNumRepository) SearchWithTx(tx *firestore.Transaction, param *PaymentNumSearchParam, q *firestore.Query) ([]*model.PaymentNum, error) {
	return repo.search(tx, param, q)
}

// SearchByParamWithTx - search documents by search param in transaction
func (repo *paymentNumRepository) SearchByParamWithTx(tx *firestore.Transaction, param *PaymentNumSearchParam) ([]*model.PaymentNum, *PagingResult, error) {
	return repo.searchByParam(tx, param)
}

// GetWithTx - get `PaymentNum` by `PaymentNum.ID` in transaction
func (repo *paymentNumRepository) GetWithTx(tx *firestore.Transaction, id string, opts ...GetOption) (*model.PaymentNum, error) {
	doc := repo.GetDocRef(id)
	return repo.get(tx, doc, opts...)
}

// GetWithDocWithTx - get `PaymentNum` by *firestore.DocumentRef in transaction
func (repo *paymentNumRepository) GetWithDocWithTx(tx *firestore.Transaction, doc *firestore.DocumentRef, opts ...GetOption) (*model.PaymentNum, error) {
	return repo.get(tx, doc, opts...)
}

// InsertWithTx - insert of `PaymentNum` in transaction
func (repo *paymentNumRepository) InsertWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.PaymentNum) (_ string, err error) {
...
// UpdateWithTx - update of `PaymentNum` in transaction
func (repo *paymentNumRepository) UpdateWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.PaymentNum) (err error) {
...
// StrictUpdateWithTx - strict update of `PaymentNum` in transaction
func (repo *paymentNumRepository) StrictUpdateWithTx(tx *firestore.Transaction, id string, param *PaymentNumUpdateParam, opts ...firestore.Precondition) error {
	return repo.strictUpdate(tx, id, param, opts...)
}

// DeleteWithTx - delete of `PaymentNum` in transaction
func (repo *paymentNumRepository) DeleteWithTx(ctx context.Context, tx *firestore.Transaction, subject *model.PaymentNum, opts ...DeleteOption) (err error) {
...
// DeleteByIDWithTx - delete `PaymentNum` by `PaymentNum.ID` in transaction
func (repo *paymentNumRepository) DeleteByIDWithTx(ctx context.Context, tx *firestore.Transaction, id string, opts ...DeleteOption) (err error) {
...
// GetMultiWithTx - get `PaymentNum` in bulk by array of `PaymentNum.ID` in transaction
func (repo *paymentNumRepository) GetMultiWithTx(tx *firestore.Transaction, ids []string, opts ...GetOption) ([]*model.PaymentNum, error) {
	return repo.getMulti(tx, ids, opts...)
}

// InsertMultiWithTx - bulk insert of `PaymentNum` in transaction
func (repo *paymentNumRepository) InsertMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.PaymentNum) (_ []string, er error) {
...
// UpdateMultiWithTx - bulk update of `PaymentNum` in transaction
func (repo *paymentNumRepository) UpdateMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.PaymentNum) (er error) {
...
// DeleteMultiWithTx - bulk delete of `PaymentNum` in transaction
func (repo *paymentNumRepository) DeleteMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*model.PaymentNum, opts ...DeleteOption) (er error) {
...
// DeleteMultiByIDWithTx - delete `PaymentNum` in bulk by array of `PaymentNum.ID` in transaction
func (repo *paymentNumRepository) DeleteMultiByIDsWithTx(ctx context.Context, tx *firestore.Transaction, ids []string, opts ...DeleteOption) (er error) {
...
func (repo *paymentNumRepository) get(v interface{}, doc *firestore.DocumentRef, opts ...GetOption) (*model.PaymentNum, error) {
	var (
...
func (repo *paymentNumRepository) getMulti(v interface{}, ids []string, opts ...GetOption) ([]*model.PaymentNum, error) {
	var (
	...
	subjects := make([]*model.PaymentNum, 0, len(ids))
	mErr := NewMultiErrors()
...
func (repo *paymentNumRepository) insert(v interface{}, subject *model.PaymentNum) (string, error) {
	var (
...
func (repo *paymentNumRepository) update(v interface{}, subject *model.PaymentNum) error {
	var (
		dr  = repo.GetDocRef(subject.ID)
		err error
	)
...
func (repo *paymentNumRepository) strictUpdate(v interface{}, id string, param *PaymentNumUpdateParam, opts ...firestore.Precondition) error {
	var (
	...
	updates := updater(model.PaymentNum{}, param)
...
func (repo *paymentNumRepository) deleteByID(v interface{}, id string) error {
	dr := repo.GetDocRef(id)
	var err error
...
func (repo *paymentNumRepository) runQuery(v interface{}, query firestore.Query) ([]*model.PaymentNum, error) {
	...
	subjects := make([]*model.PaymentNum, 0)
...
func (repo *paymentNumRepository) searchByParam(v interface{}, param *PaymentNumSearchParam) ([]*model.PaymentNum, *PagingResult, error) {
	...
	if param.BillingID != nil {
		for _, chain := range param.BillingID.QueryGroup {
			query = query.Where("billing_id", chain.Operator, chain.Value)
		}
		if direction := param.BillingID.OrderByDirection; direction > 0 {
			query = query.OrderBy("billing_id", direction)
	...
	if param.PaymentNum != nil {
		for _, chain := range param.PaymentNum.QueryGroup {
			query = query.Where("payment_num", chain.Operator, chain.Value)
		}
		if direction := param.PaymentNum.OrderByDirection; direction > 0 {
			query = query.OrderBy("payment_num", direction)
			query = param.PaymentNum.BuildCursorQuery(query)
		}
	}
	if param.Cost != nil {
...
func (repo *paymentNumRepository) search(v interface{}, param *PaymentNumSearchParam, q *firestore.Query) ([]*model.PaymentNum, error) {
