...
import (
	...
	model "template/example/internal/domain/model"
)
...
type TaskRepository interface {
	...
	// get by unique field
	GetByDesc(ctx context.Context, description string) (*model.Task, error)
	GetByDescWithTx(tx *firestore.Transaction, description string) (*model.Task, error)
}
...
func (repo *taskRepository) saveIndexes(subject *model.Task) error {
	...
	})
	{
		...
		idx.AddSomething(TaskIndexLabelDoneEqual, subject.Done)
	}
...
func (repo *taskRepository) searchByParam(v interface{}, param *TaskSearchParam) ([]*model.Task, *PagingResult, error) {
	...
	if param.Desc != nil {
		...
		// The value of the "indexer" tag = "suffix,like"
	...
	if param.Done != nil {
		...
		// The value of the "indexer" tag = "equal"
...
func (repo *taskRepository) GetByDesc(ctx context.Context, description string) (*model.Task, error) {
	return repo.getByXXX(ctx, "description", description)
}

// GetByDescWithTx - get by Desc in transaction
func (repo *taskRepository) GetByDescWithTx(tx *firestore.Transaction, description string) (*model.Task, error) {
